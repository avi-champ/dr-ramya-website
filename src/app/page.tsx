	...
	return (
		<main className="bg-gray-100">
				...
				<div className="max-w-7xl mx-auto px-6 lg:px-8">
					<div className="flex justify-between items-center h-20">
						<a href="/" className="flex items-center space-x-4">
							...
							<div>
								<h1 className="font-serif font-semibold text-xl text-dark-900">
									Dr. R Ramya Bharathi
								</h1>
			...
			<section className="bg-gradient-hero relative overflow-hidden pt-32 pb-20">
				...
				<div
					className="absolute bottom-1/4 right-1/3 w-12 h-12 bg-white bg-opacity-10 rounded-full animate-float"
				...
				<div className="max-w-7xl mx-auto px-6 lg:px-8">
					<div className="text-center mb-12">
						...
						<p className="text-xl text-gray-600 font-sans max-w-3xl mx-auto">
							Evidence-based pediatric information sourced from IAP guidelines to help you care for your
							child
						</p>
					</div>
					...
					<div className="bg-blue-50 border-l-4 border-blue-500 rounded-r-xl p-6 mb-8">
						...
						<p className="text-blue-800 text-sm">
							All articles are sourced from official Indian Academy of Pediatrics (IAP) recommendations
							and evidence-based medical literature to ensure accuracy and reliability.
						</p>
					</div>
				...
				<div className="max-w-7xl mx-auto px-6 lg:px-8">
					<div className="text-center mb-20">
						...
						<p className="text-xl text-gray-500 font-sans max-w-3xl mx-auto">
							Modern healthcare solutions designed specifically for your child's unique developmental needs
					...
					<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
						{services.map((service, index) => (
							<div key={index} className="service-card" suppressHydrationWarning>
								...
								<p className="text-gray-500 font-sans leading-relaxed">{service.desc}</p>
							</div>
						))}
					</div>
				</div>
					...
					<div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
						<div>
							...
							<p className="text-lg text-gray-500 font-sans mb-6 leading-relaxed">
								With over 15 years of dedicated experience in pediatric medicine, Dr. Ramya Bharathi
								combines compassionate care with the latest medical advances to ensure your child receives
						...
						<div className="glass-card rounded-2xl p-8">
							<div className="bg-gradient-gold rounded-xl p-8 text-center">
								...
								<h3 className="font-serif text-2xl font-semibold text-dark-900 mb-2">
									Dr. R Ramya Bharathi
								</h3>
			...
			<section id="contact" className="py-24 bg-gray-50">
				<div className="max-w-5xl mx-auto px-6 lg:px-8 text-center">
					...
					<p className="text-xl text-gray-500 font-sans mb-16 max-w-3xl mx-auto">
						Contact us today for compassionate, expert pediatric care that puts your child's health and
						happiness first
					</p>
				...
				<div className="max-w-7xl mx-auto px-6 lg:px-8">
					<div className="text-center">
						<div className="mb-8">
							...
							<p className="text-accent-gold font-sans font-medium">
								MBBS, DCH, DNB(PAED) | 15+ Years Experience
							</p>
						</div>

						<div className="border-t border-gray-700 pt-8">
							<p className="text-gray-500 font-sans">
								&copy; {mounted ? new Date().getFullYear() : '2024'} Dr. R Ramya Bharathi. All rights
